...
@Component({
  selector: 'app-show-hidden',
  templateUrl: './show-hidden.component.html',
  styleUrls: ['./show-hidden.component.scss']
})
export class ShowHiddenComponent implements OnInit {

  statusDaImg: boolean = false

  infoStatus?: string = 'Visível'
  ...
  hiddenOrShow() {
    ...
    this.infoStatus = this.statusDaImg !== false? 'Escondida': 'Visível'
  }
